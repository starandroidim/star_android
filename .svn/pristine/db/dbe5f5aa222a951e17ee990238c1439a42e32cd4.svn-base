...
import com.jjpicture.mvvmstar.http.BaseResponse;
import com.jjpicture.mvvmstar.http.ExceptionHandle;
...
public class RxUtils {
     ...
     */
    public static <T> LifecycleTransformer<T> bindToLifecycle(@io.reactivex.annotations.NonNull Context lifecycle) {
     ...
     */
    public static LifecycleTransformer bindToLifecycle(@io.reactivex.annotations.NonNull Fragment lifecycle) {
        if (lifecycle instanceof LifecycleProvider) {
            return ((LifecycleProvider) lifecycle).bindToLifecycle();
        } else {
