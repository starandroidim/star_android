...
public class MultiItemViewModel<VM extends BaseViewModel> extends ItemViewModel<VM> {
    ...
    public Object getItemType() { return multiType; }

    public void multiItemType(@NonNull Object multiType) { this.multiType = multiType; }

    public MultiItemViewModel(@NonNull VM viewModel) { super(viewModel);}
